...
// update DB
  ...
  Future<void> open() async {
    // if we call the open function for the multiple time while the database is already open, we're gonna get an exception
    if (_db != null) {
      throw DatabaseAlreadyOpenException();
    }
    try {
...
class DatabaseUser {
  ...
  @override
  // covariant telling dart "hey i'm not comparable with other object of any other class, i'm only comparable with database user instances"
